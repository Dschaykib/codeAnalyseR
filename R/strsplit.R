...
#' @param type a character. Either to \code{"remove"} or keep the delimiter
...
#'   \href{https://github.com/STATWORX/helfRlein}{helfRlein} package.
#'
#'
strsplit <- function(x,
                     split,
